...
do
  ...
  #   --des 'Exp' \
  #   --itr 1 \
  #   --train_epochs 50 >logs/LongForecasting/$model_name'_exchange_rate_'$pred_len.log

    python -u run_longExp.py \
    --is_training 1 \
    --root_path ./dataset/ \
    --data_path stock.csv \
    --model_id stock_336_$pred_len \
    --model $model_name \
    --data custom \
    --features M \
    --freq d \
    ...
    --itr 1 \
    --lradj 6 \
    --train_epochs 20 >logs/LongForecasting/$model_name'_stock_'$pred_len'-2'.log
  ...
  #   --itr 1 \
  #   --lradj 6 \
  #   --train_epochs 20 >logs/LongForecasting/$model_name'_traffic_'$pred_len'-4'.log
  ...
  #     --itr 1  \
  #     --train_epochs 50 \
  #     --lradj 7 >logs/LongForecasting/$model_name'_Etth1_'$pred_len.log
