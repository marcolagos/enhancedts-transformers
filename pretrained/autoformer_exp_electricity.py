...
from eloader import TimeSeriesDataset, TimeSeriesLoader
import matplotlib.pyplot as plt
import pandas as pd
import os

PATH = "dataset/electricity.csv"
TYPE = "electricity"
DIR = "plots"
...
dataloader = TimeSeriesLoader(dataset, batch_size=841, context_size=817)
